...
function ChatContent() {
  ...
  // Collapsed/Expanded input state
  ...
  // Auto-expand input when there's content, collapse when empty
  useEffect(() => {
    if (inputValue.trim() || selectedImage || isImageUploading) {
      setIsInputExpanded(true);
    }
  }, [inputValue, selectedImage, isImageUploading]);
  ...
  // Input expansion/collapse handlers
  ...
  const handleInputClick = () => {
    ...
    }, 0); // Use 0 timeout to ensure focus happens after state update
  };
                  ...
                  <div className="relative p-[2px] backdrop-blur-xl rounded-[50px]" style={{
                    ...
                    {isInputExpanded ? (
                      ...
                      <>
                        ...
                        {/* Bottom bar with buttons - EXPANDED STATE */}
                        <div className="flex items-center justify-between mt-4 transition-all duration-300 ease-in-out">
                          <div className="flex items-center gap-4">
                            ...
                            {/* Tools Button - Only in expanded state */}
                      ...
                      // COLLAPSED STATE - Input and buttons in one row
                      <div className="flex flex-col gap-2 w-full">
                        {/* Image Preview - Show when image is selected in collapsed state */}
                        {(selectedImage || isImageUploading) && (
                        ...
                        {/* Input Section - Takes most space */}
                        <div className="relative flex-1">
                          {!inputValue && (
                            <div 
                        ...
                        <div className="flex items-center gap-3 flex-shrink-0">
                          ...
                          <Plus 
                            ...
                            onClick={() => {
                              // Don't expand automatically when uploading image
                              fileInputRef.current?.click();
                            }}
                          />
