      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm" style={{ background: 'linear-gradient(90.19deg, #4248FF 3.94%, #FF4A19 109.12%)', WebkitBackgroundClip: 'text', backgroundClip: 'text', color: 'transparent', fontWeight: 700, fontSize: '20px' }}>Your Personal Agency</p>
          ...
          <div className="space-y-6">
            <h4 style={{ background: 'linear-gradient(90.19deg, #4248FF 3.94%, #FF4A19 109.12%)', WebkitBackgroundClip: 'text', backgroundClip: 'text', color: 'transparent', fontWeight: 700, fontSize: '20px' }}>Helpful Links & Features</h4>
          ...
          {/* Information Center */}
          <div className="space-y-6">
            <h4 style={{ background: 'linear-gradient(90.19deg, #4248FF 3.94%, #FF4A19 109.12%)', WebkitBackgroundClip: 'text', backgroundClip: 'text', color: 'transparent', fontWeight: 700, fontSize: '20px' }}>Information Center</h4>
            <div className="space-y-3 text-sm" style={{ color: '#78758E', fontWeight: 400 }}>
            ...
            <div className="space-y-3">
              <h4 style={{ background: 'linear-gradient(90.19deg, #4248FF 3.94%, #FF4A19 109.12%)', WebkitBackgroundClip: 'text', backgroundClip: 'text', color: 'transparent', fontWeight: 700, fontSize: '20px' }}>Keep in touch</h4>
              <div className="flex space-x-4">
                <Link href="#" className="w-8 h-8 rounded-full flex items-center justify-center hover:bg-white/20 transition-colors">
                  <Image src="/web.svg" alt="Web" width={24} height={24} />
                </Link>
                <Link href="#" className="w-8 h-8 rounded-full flex items-center justify-center hover:bg-white/20 transition-colors">
          ...
          <div className="space-y-6">
            <div className="flex space-x-4 text-sm">
              <Link href="/" className="hover:text-white transition-colors" style={{ color: 'white', fontWeight: 700, fontSize: '16px' }}>HOME</Link>
              <Link href="" className="hover:text-white transition-colors" style={{ color: 'white', fontWeight: 700, fontSize: '16px' }}>Pricing</Link>
              <Link href="" className="hover:text-white transition-colors" style={{ color: 'white', fontWeight: 700, fontSize: '16px' }}>Services</Link>
            </div>
            
            <div className="space-y-4">
              <h4 className="text-lg font-semibold" style={{ color: '#4248FF' }}>Subscribe & get offers and updates</h4>
              <div className="space-y-3">
                <input 
                  type="email"
...
export default function PricingPage() {
  ...
  return (
    <>
      <Head>
        <title>Pricing - VIZZY | Your Personal Marketing Agency</title>
        <meta name="description" content="Choose the perfect marketing package for your business. Agency-quality solutions at affordable prices." />
